...
insert  into `account`(`id`,createdAt,`name`,`role`,`password`) values (1,'2017-04-13','admin','admin','password');
...
insert  into `category`(`id`,`created_at`,`name`,`availabale`) values (1,'2017-04-20','1st ',1);
...
insert  into `order`(`id`,`created_at`,`table_id`,`time_in`,`tiem_out`,`discout_id`,`user_id`,`price`,`quantity`,`booking_id`) values (1,'2017-04-20',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `product`(`id`,`created_at`,`category_id`,`price`,`available`,`name`) values (1,'2017-04-20',1,500,1,'lol'),(2,NULL,NULL,NULL,NULL,NULL),(3,'2017-04-20',1,100,1,'lol'),(4,'2017-04-20',1,990,1,'LOLOLOLO');
